...
export default function Navbar() {
  ...
  return (
    <nav className="nav_container w-full flex flex-col items-center sm:gap-3 top-0 z-50 pb-4">
      <LabStatus />
        ...
        <div>
          {isMobile ? (
            ...
            <div className="flex flex-row items-center justify-between mt-4 md:mt-0 gap-6">
              <ul className="flex flex-row items-center text-foreground font-raleway text-label-l font-bold gap-6">
                <li>
                  <Link href="/">Home</Link>
                </li>
