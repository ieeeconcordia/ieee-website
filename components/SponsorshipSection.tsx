...
export const SponsorshipSection = () => {
  return (
    <div className="flex flex-col bg-sponsorship gap-6 text-center justify-center p-10">
    <h2 className="font-lora font-bold text-display-m text-white">Sponsors</h2>
